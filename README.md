...
Check PKCS12 formatted certificates with file pattern "/etc/ssl/\*.pfx"

<pre>
$ ./ssl-cert-check.sh -k "123456" -d "/etc/ssl/*.pfx"
Host                                            Status       Expires      Days
----------------------------------------------- ------------ ------------ ----
FILE:/etc/ssl/example1.org.pfx                    Valid        Jan 6 2017   78
FILE:/etc/ssl/example2.org.pfx                    Valid        Jan 1 2017   73
</pre>
